...
export const createLocalCourse = (payload) => {
  ...
  const record = {
    ...
    slug: payload.slug || payload.routeSlug || null,
    routeSlug: payload.routeSlug || payload.slug || null,
    isActive: payload.isActive !== undefined ? Boolean(payload.isActive) : true,
    featured: payload.featured !== undefined ? Boolean(payload.featured) : true,
    imageUrl: payload.imageUrl || payload.thumbnail || "",
    ...
    recordedClassTitle: payload.recordedClassTitle || null,
    ...
    liveEndedAt: payload.liveEndedAt || null,
